...
```json
{
  "projectName" : "tanzu-java-web-app-mduser019",
  "repositoryPrefix" : "egistry.lab.livefire.dev"
}
```
## Log
```
...
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [your-registry.io/project->egistry.lab.livefire...(truncated)]
